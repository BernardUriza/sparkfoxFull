...
class AjaxComercio{
	...
	CAMBIAR LOGOTIPO
	=============================================*/	
	public function ajaxCambiarCampo(){
		$respuesta = ControladorComercio::ctrCambiarCampo();
		echo $respuesta;
	}
	...
	CAMBIAR Defaults
	=============================================*/	
	public function ajaxCambiarDefaults(){
		$respuesta = ControladorComercio::ctrCambiarDefaults();
		echo $respuesta;
	}
	...
	CAMBIAR PDF
	=============================================*/	
	public function ajaxCambiarPDF(){
		$archivo=$this->archivo;
		$CambiandofileDocumento=$this->CambiandofileDocumento;
		$respuesta = ControladorComercio::ctrActualizarPDF($archivo, $CambiandofileDocumento);
	...
	=============================================*/	
	public $rutaImagen;
	public $idArchivoImagen;
	public function ajaxCambiarRutaImagen(){
		$item = "rutaImagen";
		$valor = $this->rutaImagen;
		$respuesta = ControladorComercio::ctrActualizarLogoIcono($item, $valor);

		$item = "idArchivoImagen";
		$valor = $this->idArchivoImagen;
		$respuesta .= ControladorComercio::ctrActualizarLogoIcono($item, $valor);
		echo $respuesta;
	}
...
if(isset($_POST["defaults"])){
	$logotipo = new AjaxComercio();
	$logotipo -> ajaxCambiarDefaults();
}
/*=============================================
CAMBIAR CambiandofileDocumento
=============================================*/	
if(isset($_POST["CambiandofileDocumento"])){
	$logotipo = new AjaxComercio();
	$logotipo -> archivo = $_POST["archivo"];
	$logotipo -> CambiandofileDocumento = $_POST["CambiandofileDocumento"];
	$logotipo -> ajaxCambiarPDF();
}

/*=============================================
CAMBIAR rutaImagen
=============================================*/	
if(isset($_POST["rutaImagen"]) && !isset($_POST["defaults"])){
	$logotipo = new AjaxComercio();
	$logotipo -> rutaImagen = $_POST["rutaImagen"];
	$logotipo -> idArchivoImagen = $_POST["idArchivoImagen"];
	$logotipo -> ajaxCambiarRutaImagen();
}
/*=============================================
CAMBIAR ICONO
=============================================*/	
