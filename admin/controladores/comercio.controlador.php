...
class ControladorComercio{
	...
	SELECCIONAR PAISES
	=============================================*/
	static public function ctrSeleccionarPaises(){
		$respuesta = ModeloComercio::mdlSeleccionarPaises();
		return $respuesta;
	}
		/*=============================================
	SELECCIONAR PAISES
	=============================================*/
	static public function ctrCambiarCampo(){
		$respuesta = ModeloComercio::mdlCambiarCampo();
		return $respuesta;
	}
	static public function ctrCambiarDefaults(){
		$respuesta = ModeloComercio::mdlCambiarDefaults();
		return $respuesta;
	}
	/*=============================================
	...
	ACTUALIZAR PDF
	=============================================*/
	static public function ctrActualizarPDF($archivo,$cual){
		$tabla = "plantilla";
		$Aviso = "subirAviso";
		if($Aviso==$cual) 
			$Aviso="rutaAviso";
		...
		$respuesta = ModeloComercio::mdlActualizarPDF($tabla, $Aviso, $archivo);
		return $respuesta;
	}
}