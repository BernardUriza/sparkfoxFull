...
<div class="box box-success">
	<div class="box-header with-border">
		<h3 class="box-title">SOCIAL NETWORKS</h3>
 	...
 	<div class="box-body">
		...
		foreach ($redSocial as $key => $value){
			echo '<div class="form-group row">
					<div class="col-xs-4">
						<input type="text" class="form-control input-lg cambiarUrlEstilo" value="'.$value["estilo"].'">
					</div>
					<div class="col-xs-6">
 	...
 	<div class="box-footer">
    	<button type="button" id="guardarRedesSociales" class="btn btn-primary pull-right">Save</button>
	</div>
</div>